...
function addform ()
{
    ...
    <div class="fancy">
        <h3>新建日程</h3>
        <form id="add_form" action="ajax.php?action=add" method="post">
            <p>日程内容：<input type="text" class="input" name="event" id="event" style="width:320px"
                           placeholder="记录将要做的一件事..."></p>
    ...
    <select name="s_minute">
        ...
        <option value="50">50</option>
            ...
            <p id="p_endtime" <?php echo $display; ?>>结束时间：<input type="text" class="input datepicker" name="enddate"
                                                                  id="enddate" value="<?php echo $enddate; ?>" readonly>
    ...
    <select name="e_minute">
        ...
        <option value="50">50</option>
            ...
            <p>
                ...
                <label><input type="checkbox" value="1" id="isend" name="isend" <?php echo $chk; ?>> 结束时间</label>
            </p>
            <div class="sub_btn"><input type="submit" class="btn2 btn_ok" value="确定"> <input type="button"
                                                                                             class="btn2 btn_cancel"
                                                                                             value="取消"
    ...
    <select name="e_minute">
        ...
        <option value="50">50</option>
            ...
            <div class="sub_btn"><span class="del"><input type="button" class="btn btn_del" id="del_event"
                                                          value="删除"></span><input type="submit" class="btn btn_ok"
        ...
        $("#del_event").click(function () {
            ...
            var option = {
                ...
                onOk: function () {
                    ...
                    $.post("ajax.php?action=del", {id: eventid}, function (msg) {
                        if (msg == 1) {//删除成功
                            $.fancybox.close();
                            $('#calendar').fullCalendar('refetchEvents'); //重新获取所有日程数据
                        } else {
                            // alert(msg);
    ...
    function showResponse(responseText, statusText, xhr, $form) {
        if (statusText == "success") {
            if (responseText == 1) {
                ...
                // alert(responseText);
                window.wxc.xcConfirm(responseText);
            }
        } else {
            // alert(statusText);
            window.wxc.xcConfirm(statusText);
        }
    }
</script>
