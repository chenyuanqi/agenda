...
<div class="fancy">
    ...
    <p>日程内容：<input type="text" class="input" name="event" id="event" style="width:320px" placeholder="记录将要做的一件事..."></p>
    ...
    <div class="sub_btn"><input type="submit" class="btn2 btn_ok" value="确定"> <input type="button" class="btn2 btn_cancel" value="取消" onClick="$.fancybox.close()"></div>
    </form>
</div>
<?php }
