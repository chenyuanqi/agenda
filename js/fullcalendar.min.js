...
var defaults = {
	...
	dayNamesShort: ['周日『Sunday』','周一『Monday』','周二『Tuesday』','周三『Wednesday』','周四『Thursday』','周五『Friday』','周六『Saturday』'],
	buttonText: {
		...
		if (buttonStr) {
			$.each(buttonStr.split(' '), function(i) {
				...
				$.each(this.split(','), function(j, buttonName) {
					if (buttonName == 'title') {
						e.append("<span class='fc-header-title'><h1>&nbsp;</h1></span>");
						if (prevButton) {
...
function BasicView(element, calendar, viewName) {
	...
	function buildCellHTML(date) {
		...
		if (showNumbers) {//月视图天数数字显示
			...
			html += "<div class='fc-day-number'><span class='solarday'>"+ cnDay+"</span><span class='holiday'>"+holiday+"</span>" + date.getDate() + "</div>";
		}
